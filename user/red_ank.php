...
$name = CGT($_POST['name']);
$strana = CGT($_POST['strana']);
$gorod = CGT($_POST['gorod']);
$osebe = CGT($_POST['osebe']);
$stat = CGT($_POST['stat']);
$skype = CGT($_POST['skype']);
$icq = CGT($_POST['icq']);
$url = CGT($_POST['url']);
...
if($user['prev'] == 0){ echo '<a class="log" href="'.$HOME.'/user/us/new_nick.php" style="border-radius: 6px; padding: 8px; padding-left: 15px; padding-right: 15px; font-size: 13px; display: inline-block; margin-top: 10px;">Изменить ник за 100 <b>₽</b></a></br><br />'; }
elseif($user['prev'] == 1){ echo '<a class="log" href="'.$HOME.'/user/us/new_nick.php" style="border-radius: 6px; padding: 8px; padding-left: 15px; padding-right: 15px; font-size: 13px; display: inline-block; margin-top: 10px;">Изменить ник</a></br><br />'; }
elseif($user['prev'] == 2){ echo '<a class="log" href="'.$HOME.'/user/us/new_nick.php" style="border-radius: 6px; padding: 8px; padding-left: 15px; padding-right: 15px; font-size: 13px; display: inline-block; margin-top: 10px;">Изменить ник</a></br><br />'; }
...
if($user['prev'] == 0){ echo '<a class="log" href="'.$HOME.'/user/us/color_nick.php" style="border-radius: 6px; padding: 8px; background-color: #363636; padding-left: 15px; padding-right: 15px; font-size: 13px;">Сменить цвет ника за 100 <b>₽</b></a></br></br><hr>'; }
elseif($user['prev'] == 1){ echo '<a class="log" href="'.$HOME.'/user/us/color_nick.php" style="border-radius: 6px; padding: 8px; background-color: #363636; padding-left: 15px; padding-right: 15px; font-size: 13px;">Сменить цвет ника</a></br></br><hr>'; }
elseif($user['prev'] == 2){ echo '<a class="log" href="'.$HOME.'/user/us/color_nick.php" style="border-radius: 6px; padding: 8px; background-color: #363636; padding-left: 15px; padding-right: 15px; font-size: 13px;">Сменить цвет ника</a></br></br><hr>'; }

echo '<div class="setting_punkt">Фото профиля:</div></br><a class="log" href="'.$HOME.'/user/avatar.php" style="border-radius: 6px; padding: 8px; padding-left: 15px; padding-right: 15px; font-size: 13px;">Изменить аватар</a></br></br><hr>
