...
echo '<center><div class="icon_window"><img src="'.$HOME.'/images/lock.svg" style="width: 100px; height: 100px;"></div></center><br />';
...
<div class="menu" style="background-color: #222; padding: 10px; border-radius: 9px; border-bottom: 0px;"><center>Сумма разблокировки зависит от причины бана, узнать сумму можно перейдя на страницу <a href="'.$HOME.'/ban/pardon.php" style="color: #228e5d; cursor: pointer;">платный разбан</a>.</center></div>';
