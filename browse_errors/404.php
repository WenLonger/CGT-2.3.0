...
echo '<center><div class="ntf">404</div></center><br />';
echo '<center><div class="name_window" style="font-size: 19px; font-weight: 600; color: #d6d6d6;">Страница не найдена</div></center>
<div class="menu" style="background-color: #222; padding: 10px; border-radius: 9px; border-bottom: 0px;"><center>Страница на которую вы пытаетесь попасть не существует или была удалена.</center><br />
</div>
