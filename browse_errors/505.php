...
echo '<center><div class="ntf">505</div></center><br />';
echo '<center><div class="name_window" style="font-size: 19px; font-weight: 600; color: #d6d6d6;">Не удалось установить соединение с сервером</div></center>
<div class="menu" style="background-color: #222; padding: 10px; border-radius: 9px; border-bottom: 0px;"><center>Не удаëтся установить соединение с сервером, обратитесь к администратору сайта</center><br />
</div>
...
<br /><hr><br />
<div class="name_window" style="font-size: 19px; font-weight: 600; color: #d6d6d6;"><center>Найти другую страницу</center></div>
...
<div class="menu" style="background-color: #222; padding: 10px; border-radius: 9px; border-bottom: 0px;"><center>1. Почистите файлы cookies и кэш браузера.<br />
2. Обновите версию браузера.</center></div>';
