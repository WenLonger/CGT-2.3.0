...
echo '<center><div class="ntf">Упс...</div></center><br />';
echo '<center><div class="name_window" style="font-size: 19px; font-weight: 600; color: #d6d6d6;">Нет подключения к сети</div></center>
<div class="menu" style="background-color: #222; padding: 10px; border-radius: 9px; border-bottom: 0px;"><center>Страница не может быть загружена по причине отсудствия интернета</center><br />
</div>
<center><a class="log" href="'.$HOME.'" style="border-radius: 6px; padding: 8px; padding-left: 15px; padding-right: 15px; font-size: 13px;">Обновить</a></center>
<br /><hr><br />
