...
$about = CGT($_POST['about']);
$time_end = CGT($_POST['time_end']);
...
$blog = CGT($_POST['blog']);
$news = CGT($_POST['news']);
$stena = CGT($_POST['stena']);
$gust = CGT($_POST['gust']);
$chat = CGT($_POST['chat']);
$forum_tema = CGT($_POST['forum_tema']);
$forum_post = CGT($_POST['forum_post']);
$repa = CGT($_POST['repa']);
$friends = CGT($_POST['friends']);
...
$forum_pref_name = CGT($_POST['forum_pref_name']);
$forum_pref_style = CGT($_POST['forum_pref_style']);
...
$forum_pref2_name = CGT($_POST['forum_pref2_name']);
$forum_pref2_style = CGT($_POST['forum_pref2_style']);
...
$new_pref_name = CGT($_POST['new_pref_name']);
$new_pref_style = CGT($_POST['new_pref_style']);
$new_pref_name2 = CGT($_POST['new_pref_name2']);
$new_pref_style2 = CGT($_POST['new_pref_style2']);
