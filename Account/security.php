...
<div class="setting_punkt">Почта: <span class="mail_user">'.bb($ank['email']).'</span></div></br><a class="log" href="'.$HOME.'/user/updatemail.php" style="border-radius: 6px; padding: 8px; padding-left: 15px; padding-right: 15px; font-size: 13px;">Изменить почту</a></br><br />
...
<div class="setting_punkt">Пароль</div></br><a class="log" href="'.$HOME.'/user/updatepass.php" style="border-radius: 6px; padding: 8px; padding-left: 15px; padding-right: 15px; font-size: 13px;">Изменить пароль</a></br></br>
</div>
</div>';
